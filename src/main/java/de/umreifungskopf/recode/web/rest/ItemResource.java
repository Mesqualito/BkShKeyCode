...
/**
 * REST controller for managing {@link de.umreifungskopf.recode.domain.Item}.
 */
@RestController
@RequestMapping("/api")
public class ItemResource {
     ...
     */
    @GetMapping("/items")
    public ResponseEntity<List<Item>> getAllItems(Pageable pageable, @RequestParam(required = false, defaultValue = "false") boolean eagerload) {
