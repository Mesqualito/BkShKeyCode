...
import { ItemReferenceComponent } from 'app/entities/item-reference/item-reference.component';
...
describe('Component Tests', () => {
  describe('ItemReference Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.itemReferences[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
