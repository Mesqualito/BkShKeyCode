...
import { ItemPropertyComponent } from 'app/entities/item-property/item-property.component';
...
describe('Component Tests', () => {
  describe('ItemProperty Management Component', () => {
    let comp: ItemPropertyComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ItemPropertyComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.itemProperties[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
